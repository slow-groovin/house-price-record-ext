...
<template>
  <div class="c-block">
    ...
    <div class="c-block">
      ...
      <div>
        <Checkbox id="avgUnitPrice" :default-checked="checkAvgUnitPrice" @update:checked="(_b)=>checkAvgUnitPrice=_b"/>
        <Label for="avgUnitPrice">avg Price</Label>
      </div>
      <div>
        <Checkbox id="avgTotalPrice" :default-checked="checkAvgTotalPrice" @update:checked="(_b)=>checkAvgTotalPrice=_b"/>
        <Label for="avgTotalPrice">avg Total Price</Label>
      </div>
      <div>
<!--        done count -->
        <Checkbox id="doneCountIn90Days" :default-checked="checkDoneCountIn90Days" @update:checked="(_b)=>checkDoneCountIn90Days=_b"/>
        <Label for="doneCountIn90Days">doneCountIn90Days</Label>
      </div>
      <div>
        <Checkbox id="onSellCount" :default-checked="checkOnSellCount" @update:checked="(_b)=>checkOnSellCount=_b"/>
        <Label for="onSellCount">onSellCount</Label>
      </div>
<!--      visit count-->
      <div>
        <Checkbox id="visitCountIn90Days" :default-checked="checkVisitCountIn90Days" @update:checked="(_b)=>checkVisitCountIn90Days=_b"/>
