 ...
 * @param hid
 */
export async function oneHouseEntry(hid: string):Promise<HouseNormal | HouseUpdateBase | HouseSold | undefined> {
	...
	if (fetchRs.status === 200 && !fetchRs.redirected) { // normal, still running
