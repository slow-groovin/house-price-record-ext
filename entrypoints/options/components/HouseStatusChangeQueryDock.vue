  ...
  <div :class="cn('flex flex-wrap gap-4', props.class)">
    ...
    <div class="flex flex-col">
      ...
      <div class="grid grid-rows-2 grid-flow-col gap-2">
        ...
        <SelectButton :value="HouseTaskStatus.sold" v-model="queryCondition.oldValue">售出</SelectButton>
    ...
    <div class="flex flex-col">
      ...
      <div class="grid grid-rows-2 grid-flow-col gap-2">
        ...
        <SelectButton :value="HouseTaskStatus.sold" v-model="queryCondition.newValue">售出</SelectButton>
