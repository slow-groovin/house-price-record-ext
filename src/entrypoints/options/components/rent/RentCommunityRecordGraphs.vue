...
<template>
  <div class="flex flex-row flex-wrap gap-6">
    <div class="rounded-xl p-1 border min-w-[16rem] max-w-full" :style="{ 'width': graphWidth(data?.value?.length) }"
      v-for="{ title, type, data, yDomain } in graphDataList" :key="title">
