...
<template>
<a v-if="price" class="flex flex-row flex-nowrap items-end"
   :href="'options.html#/h/task/detail?id='+hid" target="_blank" title="查看详情">
